...
import { LockClosedIcon, RefreshIcon, BookmarkIcon, SparklesIcon } from '../constants';
  ...
  return (
    <div className="flex items-center h-12 px-2 bg-gray-50 dark:bg-primary">
      ...
      <div className="flex items-center space-x-1">
        ...
        <button onClick={onShowAiAssistant} className="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-secondary text-blue-500 dark:text-accent">
            <SparklesIcon />
        </button>
